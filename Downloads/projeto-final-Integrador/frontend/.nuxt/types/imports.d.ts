...
declare global {
  ...
  const { ceilandiaLocations, getLocationById, getLocationOptions, getLocationsByType, getLocationsByTypeFilter }: typeof import('../../utils/locations')
  ...
  const { useCategories }: typeof import('../../composables/useCategories')
  const { useEmailSimulation }: typeof import('../../composables/useEmailSimulation')
  const { useEmailVerification }: typeof import('../../composables/useEmailVerification')
  const { useFetch, useLazyFetch }: typeof import('../../node_modules/nuxt/dist/app/composables/fetch')
  const { useFirestore }: typeof import('@vueuse/firebase/useFirestore')
  const { useHome }: typeof import('../../composables/useHome')
  ...
  const { useLocations }: typeof import('../../composables/useLocations')
  const { useNotifications }: typeof import('../../composables/useNotifications')
  ...
  const { useProfessionalRegistration }: typeof import('../../composables/useProfessionalRegistration')
  const { useRTDB }: typeof import('@vueuse/firebase/useRTDB')
  const { useRequestURL }: typeof import('../../node_modules/nuxt/dist/app/composables/url')
  const { useReviews }: typeof import('../../composables/useReviews')
  ...
  const { useServices }: typeof import('../../composables/useServices')
  const { useStats }: typeof import('../../composables/useStats')
  const { useSupabase }: typeof import('../../composables/useSupabase')
  const { useSupabaseClient }: typeof import('../../node_modules/@nuxtjs/supabase/dist/runtime/composables/useSupabaseClient')
  const { useSupabaseCookieRedirect }: typeof import('../../node_modules/@nuxtjs/supabase/dist/runtime/composables/useSupabaseCookieRedirect')
  const { useSupabaseSession }: typeof import('../../node_modules/@nuxtjs/supabase/dist/runtime/composables/useSupabaseSession')
  const { useSupabaseUser }: typeof import('../../node_modules/@nuxtjs/supabase/dist/runtime/composables/useSupabaseUser')
  const { useUserType }: typeof import('../../composables/useUserType')
  const { useValidation }: typeof import('../../composables/useValidation')
}
// for type re-export
declare global {
  // @ts-ignore
